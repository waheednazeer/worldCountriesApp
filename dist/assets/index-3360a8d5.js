...
`;document.querySelector(".country-card").innerHTML=l}function C(e){const l=`
    ...
    `;document.querySelector(".int-card").innerHTML=l}function A(){const e=`
        ...
        `;document.querySelector(".ulist").innerHTML=e}function T(e){const l=`
