...
3: Capital/ Small/ Title case allowed`)}let F="../src/json/wbApi.json";const P="https://country-facts.p.rapidapi.com/all",b={method:"GET",headers:{"X-RapidAPI-Key":"e043c650acmsh63deaedd48e9328p1a92efjsnf43078bac6db","X-RapidAPI-Host":"country-facts.p.rapidapi.com"}};h();document.querySelector("#btn").addEventListener("click",q);document.querySelector(".help").addEventListener("click",x);let j=f("wbKey");j==null&&(console.log("First Api Fetch!!!"),S(F,"wbKey"));let I=f("apiKey");I==null&&(console.log("First Api Fetch!!!"),E(P,b,"apiKey"));
