...
`;document.querySelector(".country-card").innerHTML=l}function C(e){const l=`
    ...
    `;document.querySelector(".int-card").innerHTML=l}function T(){const e=`
        ...
        `;document.querySelector(".ulist").innerHTML=e}function L(e){const l=`
